...
void isc_erase_flash(){
        unsigned char flash_erase[4] = { 0x0E, 0x0E, 0x00, 0x00  }; // Command bytes to send (0E 0E 00 00)
        i2c_write_byte(4,flash_erase);
...
void lsc_init_address(){
        ...
        i2c_write_byte(4,lsc_init_address);
        printf("Address of internal flash set\n");
